...
export default function TodoList({todos, deleteTodo, doneTask, darkMode}){
    ...
    return(
        ...
        <div className="flex justify-around items-center flex-wrap gap-2 w-ful max-w-4xl max-auto m-5">
            ...
            <div  className=" space-y-4 max-h-[300px] md:max-h-[400px] overflow-y-auto overflow-x-hidden w-full">
                ...
                <ul>
                    ...
                    {todos.map((todo) => (
                        <div className="flex justify-between items-center gap-2 w-full bg-gray-300 shadow-xl/20 rounded-2xl p-3 m-10 break-all whitespace-normal ">
