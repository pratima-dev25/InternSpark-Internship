...
export default function TodoList({todos, deleteTodo, doneTask, darkMode}){
    ...
    return(
        ...
        <div className="flex justify-around items-center flex-wrap gap-2 w-full max-w-7xl max-auto m-5">
            ...
            <div  className=" space-y-4 max-h-[300px] md:max-h-[400px] overflow-y-auto overflow-x-hidden w-full px-2">
                ...
                <ul>
                    ...
                    {todos.map((todo) => (
                        <div className="flex justify-between items-center gap-2 w-full bg-gray-300 shadow-xl/20 rounded-2xl p-3 my-4 break-all whitespace-normal ">

                            <li className=" flex-1 md:text-xl list-disc list-inside h-10" key={todo.id}>
